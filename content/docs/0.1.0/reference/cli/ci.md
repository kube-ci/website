...
* [ci logs](/docs/0.1.0/reference/cli/ci_logs)	 - Get workplan logs
* [ci trigger](/docs/0.1.0/reference/cli/ci_trigger)	 - Trigger workflow
* [ci version](/docs/0.1.0/reference/cli/ci_version)	 - Prints binary version number.
