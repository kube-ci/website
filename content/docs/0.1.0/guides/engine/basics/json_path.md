...
You can also use KubeCI CLI to manually trigger workflows with request object. In order to use KubeCI CLI as `kubectl` plugin follow the steps [here](/docs/0.1.0/setup/cli/install).
